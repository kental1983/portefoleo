...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/style.css"> <!-- Adicionar referência ao CSS -->
...
<nav class="topbar">
    <ul>
        ...
        <li><a href="../index.html#cv">Corriculum</a></li>
...
<div class="calculadora" style="background-image: url('../imagens/fundo-abstrato-com-design-baixo-poli.jpg'); background-size: cover; background-position: center;">
    <div class="calculadora-content" style="background-color: rgba(255, 255, 255, 0.5); padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);">
...
<script src="../script/scroolbar.js"></script>
</body>
</html>
